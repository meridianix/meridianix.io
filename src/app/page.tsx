    ...
    <div className="min-h-screen bg-[var(--background)]">
      ...
      <div className="lg:grid lg:grid-cols-[340px_1fr]">
        ...
        <aside className="hidden lg:block sticky top-0 h-screen overflow-y-auto border-r border-[var(--border)] bg-[var(--background)]">
          <div className="p-6 pl-12 xl:pl-20">
            ...
            <nav className="space-y-1 pt-6">
              <Link
                href="/projects"
                className="flex items-center gap-2 px-3 py-2 text-[var(--sidebar-link)] hover:text-[var(--sidebar-link-hover)] hover:bg-[var(--card-bg)] rounded-md transition-all"
              >
        ...
        <main className="min-h-screen bg-[var(--background)]">
          {/* Hero */}
          <div className="py-8 lg:pt-12 lg:pb-8 px-6 lg:pl-20 lg:pr-12 border-b border-[var(--border)]">
            <div className="animate-slide-up">
              <div className="lg:hidden w-[100px] h-[100px] rounded-full overflow-hidden mb-4 -mt-2">
                <Image src="/img/pfp.jpg" alt="Meridianix" width={100} height={100} className="w-full h-full object-cover object-center" />
              </div>
              <h1 className="text-3xl lg:text-5xl font-medium tracking-tight text-[var(--header-text)] mb-6">
                Hi, I&apos;m @meridianix!
              </h1>
              <div className="flex items-start gap-8">
                <div className="max-w-xl space-y-3">
                  <p className="text-[var(--foreground)] text-xl leading-relaxed">Software engineer, coding in public.</p>
                  <p className="text-[var(--foreground)] text-xl leading-relaxed">I build what&apos;s fun and open-source it.</p>
                  <p><a href="https://github.com/meridianix" target="_blank" rel="noopener noreferrer" className="text-[var(--accent)] text-xl hover:underline">Follow me on GitHub</a></p>
                </div>
                <div className="hidden lg:block w-[200px] h-[200px] rounded-full overflow-hidden flex-shrink-0 -mt-12 ml-20 shadow-[var(--pfp-glow)]">
                  <Image src="/img/pfp.jpg" alt="Meridianix" width={200} height={200} className="w-full h-full object-cover object-center" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 lg:py-6 lg:pl-20 lg:pr-12">
            <div className="max-w-3xl">
              <h2 className="text-2xl lg:text-[32px] text-[var(--header-text)] mb-2">Projects</h2>
              <p className="text-lg lg:text-[19px] text-[var(--foreground)] mb-8">Open-source projects I&apos;ve built.</p>
